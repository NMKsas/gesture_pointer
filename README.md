...
This repository contains `gesture_pointer` modules for ROS1 (Noetic) and ROS2 (Humble), to localize pointed targets on a planar workspace surface. Both ROS1 and ROS2 modules require pose estimation node to detect body keypoints and RGB-D stream to localize and publish pointed targets as ROS topics. 
