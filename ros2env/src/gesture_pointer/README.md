...
- Operator must be properly located in the camera's field of view. The node works only if YOLO11-node is able to detect keypoints with valid depth values 
