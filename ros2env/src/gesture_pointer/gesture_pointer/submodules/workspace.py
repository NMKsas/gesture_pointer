...
from gesture_pointer.submodules.camera_subscriber import CameraSubscriber
from gesture_pointer.utils.define_plane import get_mask_and_corners_visually
from gesture_pointer.utils.aruco_depth_mask import get_mask_and_offset_corners
...
class Workspace:
    ...
    def define_workspace_corners(self): 
        ...
        try: 
            ...
            print("No depth layer available")
            return None, None
